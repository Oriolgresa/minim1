...
angularRoutingApp.controller('mainController', function($scope) {
    $scope.message =  'Mínim MEAN';
});

angularRoutingApp.controller('estudiantsController', function($scope, $location, $http, $routeParams) {
    ...
    $scope.registrarPersona = function() {
        ...
        console.log("newStudent: ",$scope.newEstudiant );
...
angularRoutingApp.controller('filtreController', function($scope, $http, $routeParams) {
    ...
    $scope.getEstudiantsFiltrats = function(filtre) {
        if(filtre == undefined)
        {
            return;
        }
